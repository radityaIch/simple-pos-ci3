                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    ...
                                    ?>
                                    <form method="POST" action="<?php echo base_url('master_barang/delete/' . $barang->kode_barang); ?>" style="display: inline;" onsubmit="return confirm('Yakin ingin menghapus barang ini?')">
